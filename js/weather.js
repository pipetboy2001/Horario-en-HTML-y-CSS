...
const weatherEnabled = project.weather.value;

if (weatherEnabled) {
  document.getElementById("container-Weather").style.display = "block";
} else {
  document.getElementById("container-Weather").style.display = "none";
}
